...
Revision ID: c28f58b1ebab
Revises: a9dc90b15304
Create Date: 2024-09-03 16:28:19.298751
...
revision: str = 'c28f58b1ebab'
down_revision: Union[str, None] = 'a9dc90b15304'
...
def upgrade() -> None:
    ...
    sa.Column('sql_target_select_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_create_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_truncate_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_drop_statement', sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    schema='finance_meta'
    )
    ...
    sa.Column('target_table', sa.String(length=50), nullable=True),
    sa.Column('active', sa.Integer(), nullable=True),
    sa.Column('sql_source_select_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_select_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_create_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_truncate_statement', sa.Text(), nullable=True),
    sa.Column('sql_target_drop_statement', sa.Text(), nullable=True),
