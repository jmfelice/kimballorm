...
WHERE source.bridge_map_cash_flow_key IS NULL WHERE finance_dw.bridge_map_cash_flow.bridge_map_cash_flow_key = soft_delete_subquery.bridge_map_cash_flow_key
;
END;
$$
